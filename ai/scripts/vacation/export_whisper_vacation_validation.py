# ============================================
# 파일명: export_whisper_vacation_validation.py
#
# 역할:
# - vacation 도메인용으로 학습된 LoRA adapter를 다시 불러온다.
# - whisper-large-v3 base 모델에 vacation adapter를 붙인다.
# - raw/vacation/validation 안의 모든 .wav 파일을 순회하며 추론한다.
# - wav 1개당 json 1개씩 저장한다.
# - 시작 시각 / 종료 시각 / 총 소요 시간을 출력한다.
#
# 저장 경로:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/vacation_lora_validation_inference/
# ============================================
...
RAW_VALIDATION_DIR = PROJECT_ROOT / "ai/data/raw/vacation/validation"
RESULT_DIR = PROJECT_ROOT / "ai/data/results/vacation_lora"
ADAPTER_DIR = RESULT_DIR / "adapter"
PRED_DIR = RESULT_DIR / "vacation_lora_validation_inference"
...
for idx, audio_path in enumerate(tqdm(audio_files, desc="vacation validation inference"), start=1):
    print("\n" + "=" * 60)
