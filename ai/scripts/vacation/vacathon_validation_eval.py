# ============================================
# 파일명: vacation_lora_validation_eval_from_label.py
#
# 역할:
# - vacation validation 데이터를 대상으로
#   whisper-large-v3 base 모델 + vacation LoRA adapter를 사용하여 평가한다.
# - label/val 폴더의 라벨 파일과 validation wav를
#   파일명 규칙 기반으로 매칭한다.
# - 샘플별 예측 결과(JSON)와 전체 평가 지표(JSON)를 저장한다.
#
# 입력:
# - 라벨 폴더:
#   /home/user/SWPJ3/auto-subtitle-service/ai/data/raw/vacation/label/val
# - 오디오 폴더:
#   /home/user/SWPJ3/auto-subtitle-service/ai/data/raw/vacation/validation
# - 어댑터 폴더:
#   /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/adapter
#
# 출력:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/val_json/vacation_lora_validation_predictions.json
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/val/vacation_lora_validation_metrics.json
# ============================================
...
def main():
    ...
    for idx, pair in enumerate(tqdm(matched_pairs, desc="Vacation LoRA validation")):
        ...
        if loss_skipped:
            ...
            print(
                ...
                f"idx={idx}, label={pair['label_name']}, len={len(label_ids)}"
            )
    ...
    pred_out_path = VAL_JSON_DIR / "vacation_lora_validation_predictions.json"
    metric_out_path = VAL_METRIC_DIR / "vacation_lora_validation_metrics.json"
