# ============================================
# 파일명: vacation_validation_eval.py
#
# 역할:
...
#
# 출력:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/val_json/vacation_validation_predictions.json
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/vacation_lora/val/vacation_validation_metrics.json
#
# 평가 지표:
...
#
# 목적:
# - 학습이 끝난 vacation adapter가 validation 세트에서 어느 정도 성능을 내는지 확인한다.
