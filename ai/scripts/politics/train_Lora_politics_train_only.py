...
MANIFEST_DIR = PROJECT_ROOT / "ai/data/processed/politics"
RESULT_DIR = PROJECT_ROOT / "ai/data/results/politics_lora"
...
class PoliticsSpeechDataset(Dataset):
...
train_dataset = PoliticsSpeechDataset(
