# ============================================
# 파일명: train_lora_ent_train_only_lowmem.py
#
# 역할:
# - whisper-large-v3 base 모델 로드
# - ent 도메인용 LoRA adapter 부착
...
MANIFEST_DIR = PROJECT_ROOT / "ai/data/processed/ent"
RESULT_DIR = PROJECT_ROOT / "ai/data/results/ent_lora"
...
class EntSpeechDataset(Dataset):
...
train_dataset = EntSpeechDataset(
