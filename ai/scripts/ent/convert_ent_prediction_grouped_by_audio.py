# ============================================
# 파일명: convert_ent_predictions_grouped_by_audio.py
#
# 역할:
# - ent_validation_predictions.json 파일을 읽는다.
...
OUTPUT_DIR = Path(
    "/home/user/SWPJ3/auto-subtitle-service/ai/data/results/ent_lora/validation"
)
