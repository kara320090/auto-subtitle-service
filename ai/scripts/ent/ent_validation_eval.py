# ============================================
# 파일명: ent_validation_eval.py
#
# 역할:
# - ent 도메인용으로 학습된 LoRA adapter를 다시 불러온다.
# - whisper-large-v3 base 모델에 ent adapter를 붙인다.
...
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/ent_lora/adapter
#
# 출력:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/ent_lora/val_json/ent_validation_predictions.json
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/ent_lora/val/ent_validation_metrics.json
#
# 평가 지표:
...
#
# 목적:
# - 학습이 끝난 ent adapter가 validation 세트에서 어느 정도 성능을 내는지 확인한다.
