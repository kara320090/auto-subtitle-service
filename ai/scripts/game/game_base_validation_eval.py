# ============================================
# 파일명: game_base_validation_eval.py
#
# 역할:
# - whisper-large-v3 base 모델만 사용하여 평가한다.
# - game validation.jsonl 전체를 대상으로 추론을 수행한다.
# - 샘플별 예측 결과(JSON)와 전체 평가 지표(JSON)를 저장한다.
#
# 입력:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/processed/game/validation.jsonl
#
# 출력:
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/game_base/val_json/game_base_validation_predictions.json
# - /home/user/SWPJ3/auto-subtitle-service/ai/data/results/game_base/val/game_base_validation_metrics.json
#
# 평가 지표:
...
#
# 목적:
# - LoRA adapter 없이 base Whisper 모델 자체 성능을 확인한다.
...
def main():
    ...
    RESULT_DIR = PROJECT_ROOT / f"ai/data/results/{DOMAIN}_base"
    ...
    pred_out_path = VAL_JSON_DIR / f"{DOMAIN}_base_validation_predictions.json"
    metric_out_path = VAL_METRIC_DIR / f"{DOMAIN}_base_validation_metrics.json"
